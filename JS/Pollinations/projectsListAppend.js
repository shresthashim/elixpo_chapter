let firstFocusSegment = 'Featured Section'; 
document.addEventListener('DOMContentLoaded', () => {
    ...
    function getScrollTopToCenterElementIndex(index) {
        ...
        // console.log(`getScrollTopToCenterElementIndex: index=${index}, targetScrollTop=${targetScrollTop}`);
    ...
    segmentList.addEventListener('click', (e) => {
        ...
        if (!isNaN(clickedIndex) && clickedIndex !== -1) {
            ...
            delayedShowProjectDetails(`Segment ${clickedIndex + 1}`);
        }
    });
    ...
    requestAnimationFrame(() => {
         setDynamicPadding();
        const initialContentText = firstFocusSegment;
        const segments = segmentList.querySelectorAll('.segment-item');
