...
# Load the model
model = load_model(r'C:\Users\ELIXPO\Desktop\elixpo.ai\python_ml\prompt_classifier_model.h5')

# Load the tokenizer
with open(r'C:\Users\ELIXPO\Desktop\elixpo.ai\python_ml\prompt_classifier_tokenizer.pkl', 'rb') as f:
