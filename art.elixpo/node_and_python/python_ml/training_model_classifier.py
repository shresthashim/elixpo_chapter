...
model = load_model(r'C:\Users\ELIXPO\Desktop\elixpo.ai\python_ml\trained_model.h5')

# Load the tokenizer
with open(r'C:\Users\ELIXPO\Desktop\elixpo.ai\python_ml\tokenizer.pkl', 'rb') as f:
