...
document.getElementById("redirectStyles").addEventListener("click", function () {
...
document.querySelectorAll(".themes").forEach(function (element) {
  element.addEventListener("click", function () {
    ...
    document.getElementById("themeShowCaseHolder").style.background = `url(../../CSS/IMAGES/PREVIEW_IMAGES/${this.getAttribute(
      "data-theme"
    )}_preview.JPG)`;
