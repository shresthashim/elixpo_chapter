...
node /home/pi/elixpo.ai/server_networks/getImage.js &
echo "image.js is running in the background with PID $!"

node /home/pi/elixpo.ai/server_networks/pimpPrompt.js &
echo "pimpPrompt.js is running in the background with PID $!"

# Move to the project directory
cd /home/pi/elixpo.ai/
...
python /home/pi/elixpo.ai/server_networks/tagAdding.py &
