...
function handleSelectionChange() {
  ...
  console.log(currentSelection.range.commonAncestorContainer.parentElement.classList.value)
  updateInlineStyleButtons(currentSelection.range.commonAncestorContainer.parentElement, currentSelection.range.commonAncestorContainer.parentElement.classList.value);
  }
  else 
  {
    currentSelection = {
...
function updateInlineStyleButtons(element, className) {
  ...
  if(currentSelection.isSelectionActive)
  {
     if (element && className) {
    const styleClass = className.split(' ').find(cls => ['bold', 'italic', 'strike', 'underline', 'mark', 'code-inline'].includes(cls));
  ...
  {
    console.log("manipulating no selection")
    if (element && className) {
    const styleClass = className.split(' ').find(cls => ['bold', 'italic', 'strike', 'underline', 'mark', 'code-inline', 'default-text'].includes(cls));
    console.log("The class name is " + styleClass)
