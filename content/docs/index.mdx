...
```bash tab="pnpm"
pnpm dlx shadcn@latest add https://fingui/r/utils.json
```
...
```bash tab="bun"
bunx shadcn@latest add https://ui.fingui.dev/r/card-05.json
```
 
```bash tab="npx"
npx shadcn@latest add https://ui.fingui.dev/r/card-05.json
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://ui.fingui.dev/r/card-05.json
```
...
```jsx
import Card05 from "@/components/fingui/card-05";
...
```bash tab="bun"
bunx shadcn@latest add https://ui.fingui.dev/r/ai-card-generation.json
```
 
```bash tab="npx"
npx shadcn@latest add https://ui.fingui.dev/r/ai-card-generation.json
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://ui.fingui.dev/r/ai-card-generation.json
```
 ...
 */
import AICardGeneration from "@/components/fingui/AICardGeneration";
...
```bash tab="bun"
bunx shadcn@latest add https://ui.fingui.dev/r/card-05.json -c ./apps/www
```
 
```bash tab="npx"
npx shadcn@latest add https://ui.fingui.dev/r/card-05.json -c ./apps/www
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://ui.fingui.dev/r/card-05.json -c ./apps/www
```
