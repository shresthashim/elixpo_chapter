...
import Faq from "@/app/(home)/components_for_home/FAQ";
...
const Skiper19 = () => {
  ...
  return (
    <section
      ref={ref}
      className="mx-auto flex h-[350vh] w-screen flex-col items-center overflow-hidden px-4 text-[#021420] dark:text-white"
    >
      <div className="mt-42 relative flex w-fit flex-col items-center justify-center gap-5 text-center">
        ...
        <LinePath
          className="absolute -right-[30%] top-0 z-0"
