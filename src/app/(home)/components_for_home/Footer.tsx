...
const Footer = () => {
  ...
  <div className="flex flex-col items-center md:items-start gap-2">
    <span className="text-xs font-mono">fingui$in@gmail.com</span>
    <p className="text-xs font-mono">India, Kolkata</p>

    <div className="flex flex-wrap justify-center md:justify-start items-center gap-4 mt-2">
      <a href="#" className="flex items-center gap-1 text-xs font-mono hover:underline">
  ...
  <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-center md:text-left">
    ...
    <div className="flex flex-col sm:flex-row items-center gap-3">
      ...
      <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 items-center text-xs">
        <span>© In_Cognita - 2025</span>
        <span>(Credits) — Pierre Patrault & Aristide Benoist</span>
      </div>
    </div>
