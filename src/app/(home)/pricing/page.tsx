      ...
      <div className='container  mx-auto'>
       ...
       {/*  <Image alt='' className='mx-auto mt-2  w-32 h-32' src={logos.logo7} /> */}
        <div className='text-center text-3xl md:text-6xl font-bold' style={{fontFamily: "poppins"}}>
            <h1>Find the <span className="text-3xl md:text-6xl font-extrabold dark:text-transparent bg-clip-text dark:bg-gradient-to-r from-yellow-500 via-red-400 to-pink-500 glow-gradient animate-gradientShift" >perfect</span> plan,</h1>
