 ...
 if (inlineCompletionProviderRef.current) {
    ...
    return (
        <div className="h-full relative w-full">
            ...
            {
  suggestionLoading && (
    <div className="absolute font-mono top-2 right-2 z-10 bg-blue-100 dark:bg-blue-900 px-2 py-1 rounded text-xs text-blue-700 dark:text-blue-300 flex items-center gap-1">
  ...
  currentSuggestionRef.current && !suggestionLoading && (
    <div className="absolute top-2 right-2 z-10 font-mono bg-green-100 dark:bg-green-900 px-2 py-1 rounded text-xs text-green-700 dark:text-green-300 flex items-center gap-1">
